...
#---------------------------------------------------------------------------------------------------
#---------------------------------实体类---------------------------------
-keep class com.smartwang.project.entity.** { *; }
-keep class com.smartwang.project.entity.** { *; }
#---------------------------------工具类--------------------------------
#-keep class com.bihang.wallet.utils.** { *; }
...
#下面中括号的地方需要要填你的包名
-keep public class [com.smartwang.project].R$*{
...
#libzxing
-dontwarn com.xys.libzxing.**
-keep class com.xys.libzxing.** { *;}
#bingoogolapple
...
#ObjectBox
-dontwarn com.smartwang.project.db.**
-keep class com.smartwang.project.db.** { *; }
-keep class butterknife.** { *; }
-dontwarn butterknife.internal.**
-keep class **$$ViewBinder { *; }
