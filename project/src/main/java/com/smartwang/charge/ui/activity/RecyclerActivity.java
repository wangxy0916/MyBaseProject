...
public class RecyclerActivity extends BaseActivity implements OnRefreshListener, OnLoadMoreListener {
    //asdf
    private List<EmptyBean> alldata = new ArrayList<>();
    private List<EmptyBean> data = new ArrayList<>();
